...
# import celery # Old import
from celery import signals as celery_signals  # New import for signals
from fastapi import Request


@celery_signals.setup_logging.connect  # Use the new imported name
